...
const Home = () => {
    ...
    return (
        <section className="">
            {/* Brand hero — crawlable text for WhatsApp Business verification */}
            <div className="container mx-auto px-4 pb-2 pt-6 md:px-2 lg:px-0">
                <h1 className="text-2xl font-bold text-[#1F2937] md:text-4xl">
                    {t("homeBrandName")}
                </h1>
                <p className="mt-2 text-base text-[#1F2937]/90 md:text-lg">
                    {t("homeBrandTagline")}
                </p>
                <p className="mt-1 text-sm font-medium text-[#B89A4A] md:text-base">
                    {t("homeBrandEntityLine")}
                </p>
                <div className="mt-4 rounded-xl border border-[#B89A4A]/30 bg-[#B89A4A]/5 p-4 md:p-5">
                    <p className="text-sm font-semibold text-[#1F2937] md:text-base">
                        {t("getVerifiedKycCta")}
                    </p>
                    <p className="mt-1.5 text-sm leading-relaxed text-[#1F2937]/80">
                        {t("getVerifiedKycHint")}
                    </p>
                    <Link
                        href={`/my-profile/verification?lang=${languageCode || "en"}`}
                        className="mt-3 inline-flex items-center justify-center rounded-lg bg-[#B89A4A] px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[#a6883f]"
                    >
                        {t("getVerifiedKycCta")}
                    </Link>
                </div>
