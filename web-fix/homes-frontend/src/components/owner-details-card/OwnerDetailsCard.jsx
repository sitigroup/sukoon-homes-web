...
const SukoonOwnerTrustSection = dynamic(
  () => import("@/plugins/trust-verification/ui/SukoonOwnerTrustSection"),
  { ssr: false, loading: () => null },
);

const SukoonTenantReliabilitySection = dynamic(
  () => import("@/plugins/trust-verification/ui/SukoonTenantReliabilitySection"),
  { ssr: false, loading: () => null },
);

const OwnerDetailsCard = ({
  ownerData,
  /** Tenant applicant customer ID (owner screening) — not property owner added_by */
  ...
  return (
    <div className="cardBg newBorder mb-7 overflow-hidden rounded-2xl">
      ...
      <div className="relative -mt-10 p-2 md:p-3   md:-mt-8 lg:-mt-8 lg:p-5">
        ...
        {added_by ? <SukoonOwnerTrustSection customerId={added_by} /> : null}

        {tenantCustomerId ? (
          <SukoonTenantReliabilitySection customerId={tenantCustomerId} />
        ) : null}
