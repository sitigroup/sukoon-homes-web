...
const AllListings = () => {
  ...
  const breadCrumbItems = [
    { href: `/all/${slug}`, label: t(slug) },
  ];

  const homeLang = language || router.query?.lang || "en";
    ...
    <div>
      ...
      >
        <div className="container mx-auto px-4 py-10">
          <Link
            href={`/?lang=${homeLang}`}
            className="brandBorder brandColor hover:primaryBg mb-6 inline-flex items-center gap-2 rounded-lg border bg-white px-4 py-2.5 text-sm font-medium transition-colors duration-300 hover:border-transparent hover:text-white"
          >
