...
import { mergeStructuredData, searchBreadcrumbList } from '@/utils/jsonld';
  ...
  serverSidePropsFunction = async (context) => {
    ...
    const structuredData = mergeStructuredData(
      ...
      searchBreadcrumbList({
        ...
        lang,
        labels: {
          city: slugToDisplayName(citySlug),
          area: slugToDisplayName(areaSlug),
          subArea: slugToDisplayName(subAreaSlug),
        },
      })
    );
