...
import { fetchSeoPublicSettings } from '@/plugins/seo-engine/rentLeadApi';
import {
...
if (process.env.NEXT_PUBLIC_SEO === 'true') {
  serverSidePropsFunction = async (context) => {
    ...
    const seoSettings = await fetchSeoPublicSettings();
    const ga4 = seoSettings?.ga4_enabled && seoSettings?.ga4_measurement_id
      ? { enabled: true, measurementId: seoSettings.ga4_measurement_id }
