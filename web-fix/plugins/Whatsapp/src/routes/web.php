...
use App\Plugins\Whatsapp\Http\Controllers\Admin\WhatsappBatchReminderController;
...
Route::middleware(['auth:sanctum'])->group(function () {
    Route::prefix('whatsapp')->group(function () {
        ...
        Route::get('/batch-reminders', [WhatsappBatchReminderController::class, 'index'])
            ->name('whatsapp.batch-reminders.index');
        Route::post('/batch-reminders/preview-rent', [WhatsappBatchReminderController::class, 'previewRent'])
            ->name('whatsapp.batch-reminders.preview-rent');
        Route::post('/batch-reminders/run-rent', [WhatsappBatchReminderController::class, 'runRent'])
            ->name('whatsapp.batch-reminders.run-rent');
        Route::post('/batch-reminders/preview-renewal', [WhatsappBatchReminderController::class, 'previewRenewal'])
            ->name('whatsapp.batch-reminders.preview-renewal');
        Route::post('/batch-reminders/run-renewal', [WhatsappBatchReminderController::class, 'runRenewal'])
            ->name('whatsapp.batch-reminders.run-renewal');
