...
Route::middleware(['web', 'auth:sanctum,web', 'checkLogin'])->prefix('area-listing')->name('area-listing.')->group(function () {
...
Route::middleware(['web', 'auth', 'checkLogin'])->prefix('area-listing')->name('area-listing.')->group(function () {
    ...
    Route::post('suggestions/group/{groupToken}/approve-all', [AreaListingAdminController::class, 'approveGroupSuggestion'])->name('suggestions.approve-group');
    Route::post('suggestions/group/{groupToken}/approve-area-only', [AreaListingAdminController::class, 'approveAreaOnlySuggestion'])->name('suggestions.approve-area-only');
    Route::post('suggestions/group/{groupToken}/reject-all', [AreaListingAdminController::class, 'rejectGroupSuggestion'])->name('suggestions.reject-group');
    Route::post('suggestions/bulk-approve', [AreaListingAdminController::class, 'bulkApproveSuggestions'])->name('suggestions.bulk-approve');
    Route::post('suggestions/bulk-approve-area-only', [AreaListingAdminController::class, 'bulkApproveAreaOnlySuggestions'])->name('suggestions.bulk-approve-area-only');
    Route::post('suggestions/bulk-reject', [AreaListingAdminController::class, 'bulkRejectSuggestions'])->name('suggestions.bulk-reject');

    Route::post('areas/bulk-archive', [AreaListingAdminController::class, 'bulkArchiveAreas'])->name('areas.bulk-archive');
    Route::post('areas/bulk-delete', [AreaListingAdminController::class, 'bulkDeleteAreas'])->name('areas.bulk-delete');
    Route::post('areas/bulk-restore', [AreaListingAdminController::class, 'bulkRestoreAreas'])->name('areas.bulk-restore');
    Route::post('sub-areas/bulk-archive', [AreaListingAdminController::class, 'bulkArchiveSubAreas'])->name('sub-areas.bulk-archive');
    Route::post('sub-areas/bulk-delete', [AreaListingAdminController::class, 'bulkDeleteSubAreas'])->name('sub-areas.bulk-delete');
    Route::post('sub-areas/bulk-restore', [AreaListingAdminController::class, 'bulkRestoreSubAreas'])->name('sub-areas.bulk-restore');
